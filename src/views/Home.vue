<template>
    <div
        ...
        style="background-color:#afdeff; margin:0 auto;"
    >
        ...
        <div class="flex flex-col justify-center w-2/3">
            ...
            <h2 class="text-center text-2xl">
                An Educational Tool About<br />African Forest Elephants<br />and
                Carbon Emissions
            </h2>
        </div>
        <div class="w-1/3" style="background-color:white">
            <img
                ...
                alt=""
                width="200"
                style="transform:scaleX(-1); margin-left:auto; margin-right:auto"
            />
        </div>
    </div>
    <div
        ...
        <div class="w-3/5" style="margin:0 auto;">
            <div class="float-left w-1/2">
                <p>
                    ...
                    flight<br />between airports? How much money could be used
                    for elephant<br />conservation that would ultimately offset
        ...
        <div class="w-3/5" style="margin:0 auto;">
            <div class="float-left w-1/2">
                <p>
                    ...
                    The logos link to organization-specific donation<br />pages.
                    Visit the Carbon Calculator for recommendations on<br />how
                    much to donate.
                </p>
            </div>
            <div class="float-right w-1/2" style="text-align:center">
